...
$(document).ready(function () { 
    ...
    container.empty();
        ...
        for (var hour = 9; hour <= 17; hour++) {
            ...
            buttonColumn.addClass("col-sm-1");
            ...
            colorEffect(textColumn, hour); // calling function 
        }// loop end for displaying data and rows

    function colorEffect(hourRow, hour) { 
        console.log(hour);
       if (hour < hour24 || hour < hour12) {
